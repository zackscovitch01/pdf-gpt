...
//gsutil cors set cors.json gs://pdt-gpt.appspot.com
//go here >>>> https://console.cloud.google.com/
//create new file in editor calls cors.json
// run >>> gsutil cors set cors.json gs://pdt-gpt.appspot.com
    ...
    <div className="flex flex-col justify-center items-center">
      ...
      {!file ? (
        ...
        <Document
          ...
          loading={null}
          rotate={rotation}
          //WIP: come back to this end remove the overflow-scroll
